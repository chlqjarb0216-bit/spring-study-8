...
public class AdminController {
	...
	public String registerRoom() {
		...
		log.warn("경고 지금 수행은 문제 없으나 확인해볼 것");
	...
	public String rooms(Model model, RoomSearchCondition roomSearchCondition) {
		...
		List<User> roomList = roomService.findRoomListBySearchCondition(roomSearchCondition);
	...
	@PostMapping("/admin/modifyUser/{id}")
