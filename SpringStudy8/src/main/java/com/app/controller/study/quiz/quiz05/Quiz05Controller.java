...
public class Quiz05Controller {
	...
	*/
	...
	/*
	// 2+) 경로별로 모아서 표시 (상품정보기준으로 A정보, B정보 페이지 2개로 사용)
	...
	*/
	...
	/*
	// 3) pathA, pathB 각각 경로별 개별 페이지
	// 3+) pathVariable 경로에 포함된 값을 기준으로 페이지에 상품정보 표시
